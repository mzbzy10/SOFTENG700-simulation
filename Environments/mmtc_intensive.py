"""mMTC-intensive environment.

PLACEHOLDER — currently identical to balanced.py. Differentiate by raising
mMTC's share of the offered load (higher rate, or larger size_range), and
...
DESCRIPTION = "mMTC-intensive: PLACEHOLDER, currently identical to balanced"

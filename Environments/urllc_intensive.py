"""URLLC-intensive environment — URLLC takes half the offered load.

Offered load: eMBB 12.0 / URLLC 24.0 / mMTC 12.0 = 48.0 PRB/step (25/50/25).
...
This is expected to be the hardest scenario: URLLC arrives in deterministic
bursts against a 5-step delay SLA, so the same mean load is far less
reschedulable than in the other environments.
...
DESCRIPTION = "URLLC-intensive: URLLC takes half the load, 25/50/25"
...
URLLC = {
    ...
    "period":     5,
    "batch_size": 24,             # mean 4.80 tasks/step -> 24.0 PRB/step
}

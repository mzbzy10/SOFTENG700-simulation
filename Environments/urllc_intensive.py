"""URLLC-intensive environment.

PLACEHOLDER — currently identical to balanced.py. Differentiate by raising
URLLC's share of the offered load (shorter period, larger batch_size, or larger
size_range), and lowering the other two if you want the total load to stay
matched.
...
DESCRIPTION = "URLLC-intensive: PLACEHOLDER, currently identical to balanced"
